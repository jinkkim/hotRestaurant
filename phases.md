...
-  create the arrays that represent a table with an available value

* Create a set of routes for getting and posting table data
- post and get for each action such as deliver pages and present data
- every function or array  
- add someone, reserve the table
- diff array for waitlist
